...
class PlayScreen extends StatefulWidget {
  ...
  PlayScreen({Key? key, required this.streamId, required this.hostUrl})
      : super(key: key);
...
class _PlayState extends State<PlayScreen> {
  ...
  void _connect() async {
    print("Connecting to stream: " + widget.streamId);
    print("Connecting to host: " + widget.hostUrl);
    print("Connecting to userscreen: " + widget.userscreen.toString());
        ...
        (command, mapData) {
          if (command == 'notification') {
            if (mapData["definition"] == "play_started") {
              ...
              AntMediaFlutter.anthelper?.getStreamInfo(widget.streamId);
            }
                      ...
                      DropdownButton<String>(
                        ...
                        onChanged: (streamHeight) {
                          ...
                          AntMediaFlutter.anthelper?.forceStreamQuality(
                              widget.streamId,
                              int?.parse(streamHeight.toString()));
                          setState(() {
                            _currentAbr = (streamHeight == '0'
                                ? 'Automatic'
                                : streamHeight)!;
                          });
                        },
              ...
              children: <Widget>[
                _isFullScreen
                    ? Container(
                        ...
                        child: RTCVideoView(_remoteRenderer,
                            objectFit: orientation == Orientation.portrait
                ...
                _isPaused
                    ...
                    : GestureDetector(
                        ...
                        child: Container(
                          color: Colors
                              .transparent, // Makes the entire screen tappable
                          width: MediaQuery.of(context).size.width,
                          height: MediaQuery.of(context).size.height,
                          ...
                          child: const Icon(
                            Icons.pause,
                            color:
                                Colors.transparent, // Keeps the icon invisible
                          ),
                        ),
                      ),
              ],
